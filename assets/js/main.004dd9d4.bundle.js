!function(){"use strict";var e,t,n,r,l,a={9378:function(e,t,n){var r=n(7294),l=n(745),a=n(37),o=n(5538),i=n(6071),c=n(8718);a.ZP.use(o.Z).use(i.Z).use(c.Db).init({fallbackLng:"en",load:"languageOnly",backend:{loadPath:"/react-webpack-boilerplate/locales/{{lng}}/{{ns}}.json",addPath:"/react-webpack-boilerplate/locales/{{lng}}/{{ns}}"},ns:["translations","config"],defaultNS:"translations",debug:!1,interpolation:{escapeValue:!1},react:{defaultTransParent:"div"}});Boolean("localhost"===window.location.hostname||"[::1]"===window.location.hostname||window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/));var s=e=>{e&&e instanceof Function&&n.e(131).then(n.bind(n,2131)).then((({getCLS:t,getFID:n,getFCP:r,getLCP:l,getTTFB:a})=>{t(e),n(e),r(e),l(e),a(e)}))},d=n(9711),m=n(8804);const u=m.F4`
  0% {
...
`;var b=n(2327);var y=(e=20)=>{const[t,n]=(0,r.useState)(!1),l=()=>window.scrollY>=e?n(!0):n(!1);return(0,r.useEffect)((()=>(window.addEventListener("scroll",l),()=>{window.removeEventListener("scroll",l)})),[]),t};const C="/",P="/links-examples",k="/api-examples",Z="/users/:userId",z="/powered-by";var O=m.ZP.button`
  font-size: 18px;
  color: black;
...
`,fe=m.iv`
  animation: ${ue} 7s ease-in-out infinite alternate;
`,he=m.iv`
...
`,ge=m.ZP.div`
  ...
  position: relative;
  ${e=>e}
`;var Ee=()=>{const[e,t]=(0,r.useState)({width:void 0,height:void 0});return(0,r.useEffect)((()=>{const e=()=>{t({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",e),e(),()=>window.removeEventListener("resize",e)}),[]),e};const xe="#805ad5",we="#38b2ac",be="#f56565",ye=()=>r.createElement(r.Fragment,null,r.createElement(se,{top:"180px",left:"-200px"},r.createElement(ve,{animationDuration:"15s"},r.createElement(me,{size:"225px",ring:"50px",color:we}))),r.createElement(se,{top:"180px",left:"-115px"},r.createElement(ge,null,r.createElement(me,{size:"30px",ring:"5px",color:be}))),r.createElement(se,{top:"20px",left:"600px"},r.createElement(ge,null,r.createElement(me,{size:"30px",ring:"5px",color:we}))),r.createElement(se,{top:"50px",left:"700px"},r.createElement(ge,{animationDirection:"alternate-reverse"},r.createElement(me,{size:"30px",ring:"5px",color:be}))),r.createElement(se,{top:"240px",left:"500px"},r.createElement(ge,null,r.createElement(me,{size:"30px",ring:"5px",color:xe}))),r.createElement(se,{top:"70px",left:"100px"},r.createElement(ve,null,r.createElement(me,{size:"30px",ring:"5px",color:we}))),r.createElement(se,{top:"100px",left:"0px"},r.createElement(ve,null,r.createElement(me,{size:"30px",ring:"5px",color:xe}))),r.createElement(se,{top:"270px",left:"300px"},r.createElement(ge,{animationDuration:"7s"},r.createElement(me,{size:"30px",ring:"5px",color:be}))),r.createElement(se,{top:"150px",left:"200px"},r.createElement(ge,{animationDirection:"alternate-reverse"},r.createElement(me,{size:"30px",ring:"5px",color:xe}))),r.createElement(se,{top:"30px",left:"400px"},r.createElement(ve,{animationDirection:"alternate-reverse"},r.createElement(me,{size:"30px",ring:"5px",color:we}))),r.createElement(se,{top:"-180px",left:"-150px"},r.createElement(de,{height:"200px",width:"200px",deg:"135deg",primary:"#a0aec0",secondary:"#4a5568"}))," "),Ce=()=>r.createElement(r.Fragment,null,r.createElement(se,{top:"10.41vw",right:"7.8vw"},r.createElement(me,{size:"3.2vw",ring:"0.6vw",color:we})),r.createElement(se,{top:"9.89vw",right:"0"},r.createElement(me,{size:"1.4vw",ring:"0.3vw",color:we})),r.createElement(se,{top:"13.2vw",right:"3.9vw"},r.createElement(me,{size:"1.4vw",ring:"0.3vw",color:we})),r.createElement(se,{top:"-6.51vw",right:"1vw"},r.createElement(me,{size:"3.5vw",ring:"0.6vw",color:be})),r.createElement(se,{top:"2.82vw",right:"6.25vw"},r.createElement(me,{size:"1.3vw",ring:"0.3vw",color:be})),r.createElement(se,{top:"5vw",right:"1vw"},r.createElement(ve,null,r.createElement(de,{height:"7vw",width:"7vw",deg:"135deg",primary:xe,secondary:"#d6bcfa"}))),r.createElement(se,{top:"-5vw",right:"17vw"},r.createElement(ve,{animationDirection:"alternate-reverse"},r.createElement(de,{height:"7vw",width:"7vw",deg:"225deg",primary:"#9ae6b4",secondary:"#48bb78"}))));var Pe=()=>{const e=Ee().width>1200;return r.createElement(ce,null,r.createElement(ye,null),e&&r.createElement(Ce,null))};const ke=m.ZP.div`
  display: flex;
  flex: 1;
  align-items: center;
  justify-content: center;
...
`,Ve=m.ZP.div`
  ...
  z-index: 10;
  ${e=>e};
`;var Fe=()=>{const e=Ee().width>1200;return r.createElement(ke,null,r.createElement(Ze,null,r.createElement(ze,{fullWidth:!e},r.createElement(Oe,null,"NaNLabs"),r.createElement(je,null,"React Webpack Template demo")),e&&r.createElement(Le,null,r.createElement($e,{src:te,position:"absolute",alt:"logo",top:"-12vw",right:"-5vw",height:"21vw"}),r.createElement(Ve,{top:"1vw",right:"10vw"},r.createElement(ie,{fill:"#5d73f5",width:"17vw",height:"17vw",filter:"drop-shadow( 3px 3px 2px rgba(0, 0, 0, .4))"}))),r.createElement(Pe,null)))};var He=()=>r.createElement(ee,null,r.createElement(Fe,null));const Me=m.ZP.div`
  display: flex;
  flex: 1;
  min-height: 100%;
  height: 100%;
...
`,Te=m.ZP.main`
  ...
  max-width: 1240px;
  margin-top: var(--navbar-offset);
`;var Ae=({children:e})=>r.createElement(Me,{"data-component":"default-layout"},r.createElement(J,null),r.createElement(Te,null,e));var Se=()=>{const{userId:e}=(0,f.UO)();return r.createElement(Ae,null,r.createElement("div",null,"hello ",e))};const _e=[{name:"root",path:C},{name:"powered-by",path:z},{name:"user 1",path:(0,f.Gn)(Z,{userId:"1"})},{name:"user 2",path:(0,f.Gn)(Z,{userId:"2"})}];var De=()=>r.createElement(Ae,null,r.createElement("h1",null,"This is an example page"),r.createElement("hr",null),r.createElement("h3",null,"In this section we show how to generate links and dynamic links component."),r.createElement("p",null,"Check how the links are generated in the ",r.createElement("code",null,"src/pages/Links")," component."),r.createElement("hr",null),_e.map((e=>r.createElement("li",{key:e.path},r.createElement(d.rU,{to:e.path},e.name)))));var Ne=({children:e})=>r.createElement("div",{className:"bg-text"},r.createElement("div",{className:"slicer-gradient"},new Array(40).fill(1).map(((t,n)=>r.createElement("div",{key:`slice-${n+1}`,className:"text"},e)))));const We=m.ZP.div`
