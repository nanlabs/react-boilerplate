...
`,$e=d.ZP.div`
  ...
  z-index: 10;
  ${e=>e};
`;var Fe=()=>{const e=Ee().width>1200;return console.log("showIllustration",e),r.createElement(ke,null,r.createElement(Ze,null,r.createElement(ze,{fullWidth:!e},r.createElement(Oe,null,"Agregar un titulo"),r.createElement(je,null,"Agregar un subtitulo")),e&&r.createElement(Le,null,r.createElement(Ve,{src:te,position:"absolute",alt:"logo",top:"-12vw",right:"-5vw",height:"21vw"}),r.createElement($e,{top:"1vw",right:"10vw"},r.createElement(ie,{fill:"#5d73f5",width:"17vw",height:"17vw",filter:"drop-shadow( 3px 3px 2px rgba(0, 0, 0, .4))"}))),r.createElement(Pe,null)))};var He=()=>r.createElement(ee,null,r.createElement(Fe,null));const Me=d.ZP.div`
  display: flex;
  flex: 1;
  min-height: 100%;
  height: 100%;
...
`,Ae=d.ZP.main`
  ...
  max-width: 1240px;
  margin-top: var(--navbar-offset);
`;var Te=({children:e})=>r.createElement(Me,{"data-component":"default-layout"},r.createElement(Y,null),r.createElement(Ae,null,e));var Se=()=>{const{userId:e}=(0,f.UO)();return r.createElement(Te,null,r.createElement("div",null,"hello ",e))};const _e=[{name:"root",path:C},{name:"powered-by",path:z},{name:"user 1",path:(0,f.Gn)(Z,{userId:"1"})},{name:"user 2",path:(0,f.Gn)(Z,{userId:"2"})}];var Ie=()=>r.createElement(Te,null,r.createElement("h1",null,"This is an example page"),r.createElement("hr",null),r.createElement("h3",null,"In this section we show how to generate links and dynamic links component."),r.createElement("p",null,"Check how the links are generated in the ",r.createElement("code",null,"src/pages/Links")," component."),r.createElement("hr",null),_e.map((e=>r.createElement("li",{key:e.path},r.createElement(u.rU,{to:e.path},e.name)))));var De=({children:e})=>r.createElement("div",{className:"bg-text"},r.createElement("div",{className:"slicer-gradient"},new Array(40).fill(1).map(((t,n)=>r.createElement("div",{key:`slice-${n+1}`,className:"text"},e)))));const Ne=d.ZP.div`
